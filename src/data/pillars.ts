    ...
    services: [
      {
        ...
        description:
          "Every sustainability journey needs a starting point that grounded in reality, not only aspiration. We work with manufacturers to build the strategy where sustainability is embedded as business offer.",
      },
      {
        name: "Roadmap & Capacity Building",
        description:
          "Often traditional roadmaps are simply filled with data and ambitious milestones which are far from reality. We help manufacturers to create their own roadmap that is close to reality and achievable. Man behind the machines are the keys to success, thus capacity building goes hand to hand for clear roadmap.",
      },
      {
        name: "Workforce upskilling",
        description:
          "Sustainable manufacturing depends on people who understand why it matters and how to deliver. We help organizations by designing upskilling programs across mid management to shop floors, covering social compliance, environmental commitments to operational excellence.",
      },
      {
        name: "End to End ESG reporting",
        description:
          "we build infrastructure in manufacturing units which brings transparency and capture real time data. Eventually it helps to make the sustainability reporting.",
      },
    ],
    areas: [
      {
