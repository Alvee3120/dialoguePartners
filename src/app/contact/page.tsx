        ...
        <Container>
          <div className="grid gap-10 lg:grid-cols-[3fr_2fr] lg:gap-16">
            ...
            <form className="rounded-3xl border border-line bg-paper p-7 sm:p-10">
              ...
              <button
                type="submit"
                className="mt-8 inline-flex items-center gap-2 rounded-full bg-ink px-8 py-3.5 text-sm font-semibold text-white transition-colors hover:bg-ink-soft"
              >
                Send Message
            ...
            <div className="flex flex-col gap-8">
              <div className="rounded-3xl bg-ink p-7 sm:p-8">
