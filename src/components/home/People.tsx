...
export default function People() {
  return (
    <section className="border-y border-line bg-soft-teal py-20 sm:py-28">
      <Container>
        ...
        <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {people.map((person, i) => (
            <Reveal key={person.slug} delay={i * 90}>
              <article className="group overflow-hidden rounded-3xl border border-line bg-white transition-all duration-300 hover:-translate-y-1 hover:shadow-xl motion-reduce:hover:translate-y-0">
