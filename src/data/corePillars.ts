...
export const corePillars: CorePillar[] = [
  {
    ...
    pageImage:
      asset("pillar%201%20-%20Climate%20Resilience%20%26%20Decarbonization.png"),
    groups: [
      {
  ...
  },
  {
    ...
    icon: "Circuitry",
    image:
      asset("techandinnova.jpg"),
    pageImage:
      asset("Pillar%202-%20Technologu%20Solution%20and%20Innovation.png"),
    groups: [
      {
  ...
  },
  {
    ...
    icon: "HandHeart",
    image: asset("social.jpg"),
    pageImage:
      asset("pillar%203%20-%20social.png"),
    groups: [
      {
  ...
  },
  {
    ...
    icon: "Gauge",
    image:
      asset("operational.jpg"),
    pageImage:
      asset("pillar%204%20-%20Operational%20Excellence.png"),
    groups: [
      {
        title: "Our Areas of Work",
        items: [
  ...
  },
  {
    ...
    icon: "Scales",
    image: asset("trade.jpg"),
    pageImage:
      asset("Pillar%205%20(landscape).png"),
    groups: [
      {
        title: "Our Areas of Work",
        items: [
